    ...
    <div>
      ...
      <div className="bg-white pb-[178px] ">
        ...
        <div className="mx-[50px] flex gap-[52px] mt-[50px] ">
          ...
          <div className="w-[433px] py-[39px] px-[40px] rounded-[10px] shadow-xl border">
            <h1>Recent Post</h1>
        ...
        <div className="flex mx-[50px] gap-[52px]">
          <div className="w-[855px]">
            ...
            <div className="flex gap-4">
                <p className="text-[#29ABE2] text-[21px] "><FaFacebook /></p>
                <p className="text-[#29ABE2] text-[21px] "><AiFillTwitterCircle /></p>
                <p className=" text-blue-600 text-[21px] "><TiSocialLinkedinCircular /></p>
                <p className="text-green-300 text-[21px] "><RiWhatsappFill /></p>  
                <p className=" text-blue-500 text-[21px] "><FaFacebook /></p>  
            </div>
          </div>
