    ...
    <div>
      ...
      <div className="text-center mt-[81px]">
        ...
        <p className="text-gray-500 px-[280px] md:px-4 ">
          Every Project has a set goal and objective. The ability to meet such
          targets depends solely on the project management. We can help plan and
          control your project management activities from the project initiation
          phase to the post-project review to achieve great results.
        </p>
