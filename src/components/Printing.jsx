    ...
    <div>
      <div className="text-center bg-[#01303F] md:mt-7 text-white py-[30px]">
        ...
        <div className="md:mx-[20px] mx-[244px] mt-[90px]">
          <p className="text-[#29ABE2] text-[14px]">PRINTING SOLUTIONS</p>
      ...
      <div className="text-center mt-[81px]">
        ...
        <p className="text-gray-500 px-[280px] md:px-4 ">
          We are committed to providing a great solution to your printing needs
          with our quality and timely printing services. With us, you can be
          rest assured of getting quality results and a fast nationwide delivery
          of all our prints.
        </p>
