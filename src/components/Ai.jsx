    ...
    <div>
      <div className="text-center bg-[#01303F] md:mt-7 text-white py-[30px]">
        ...
        <div className="md:mx-[20px] mx-[244px] mt-[90px]">
          <p className="text-[#29ABE2] text-[14px]">AI SOLUTIONS</p>
      ...
      <div className="text-center mt-[81px]">
        ...
        <p className="text-gray-500 px-[280px] md:px-4 ">
          We are at the point in technological development where AI is at the
          intersection of systems and applications.
        </p>
        <p className="text-gray-500 mt-2 px-[280px] md:px-4 ">
          Do you need to create a bot that can reply to messages on your website
          real time? Do you need to build systems with artificial intelligence?
          Contact us today.
        </p>
