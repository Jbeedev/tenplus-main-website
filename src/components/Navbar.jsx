...
const Navbar = () => {
  ...
  return (
    <div className=" w-full ">
      ...
      <div className="mx-5 md:block 2xl:items-center mt-[30px] flex  justify-between ">
        <div className="md:flex md:justify-between md:items-center md:w-full">
          <img
            className=" 2xl:max-w-[161px] 2xl:max-h-[43px]"
            src={TenPlusLogo}
            alt="tenplus logo"
          />
        ...
        <div
          className={`md:bg-white md:rounded md:py-5 md:border border-black md:text-black md:mr-0 ${
        ...
        >
          <div className="md:flex md:flex-col md:pl-[50px] 2xl:flex 2xl:text-[16px] 2xl:gap-[27px]">
            ...
            <div>
              ...
              {navMenu && (
                <div
                  className=" absolute top-[86px] bg-white"
                  style={{ color: "#01303F" }}
                >
